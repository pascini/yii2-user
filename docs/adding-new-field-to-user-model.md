...
```php
class User extends \pascini\user\models\User
{
...
You should override view file `@pascini/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
