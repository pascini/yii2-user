...
```php
'user' => [
    'class' => \pascini\user\Module::className(),
    'controllerMap' => [
        'registration' => [
            'class' => \pascini\user\controllers\RegistrationController::className(),
            'on ' . \pascini\user\controllers\RegistrationController::EVENT_AFTER_REGISTER => function ($e) {
...
```php
\yii\base\Event::on(
    \pascini\user\controllers\RegistrationController::className(),
    \pascini\user\controllers\RegistrationController::EVENT_AFTER_CONFIRM,
    function () {        
